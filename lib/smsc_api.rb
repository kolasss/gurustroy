...
class SMSC
  ...
  SMSC_LOGIN = Rails.configuration.smsc_login     # логин клиента
  SMSC_PASSWORD = Rails.configuration.smsc_password  # пароль или MD5-хеш пароля в нижнем регистре
  ...
  SMTP_FROM = "no-reply@gurustroy.ru"   # e-mail адрес отправителя
